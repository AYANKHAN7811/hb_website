...
//             $stmt = $con->prepare("UPDATE `user_register` SET `token`=?, `t_expire`=? WHERE `id`=?");

//             $stmt->bind_param("ssi", $token, $expiry, $u_fetch['id']);
...
//                 $mail->setFrom('ayan.inayatinfotech@gmail.com');

//                 $mail->addAddress($email);

//                 $mail->Body = "
//                     Click <a href='http://localhost/hb_website/reset-password.php?token=$token'>here</a> 
